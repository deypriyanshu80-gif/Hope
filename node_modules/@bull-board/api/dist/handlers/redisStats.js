...
async function getStats(queue) {
    ...
    return {
        backend: datastores_1.DATASTORES.redis,
...
async function redisStatsHandler({ queues: bullBoardQueues, uiConfig, }) {
    if (uiConfig.hideRedisDetails) {
        return (0, errors_1.errorResponse)(403, 'ERRORS.FORBIDDEN');
    }
    ...
    if (body === null) {
        return (0, errors_1.errorResponse)(404, 'ERRORS.REDIS_STATS_UNAVAILABLE');
    }
    return {
        body,
    };
