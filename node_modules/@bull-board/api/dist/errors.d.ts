import { ControllerHandlerReturnType, ErrorResponseBody, ErrorTranslationKey, HTTPStatus, TranslatableMessage } from './types';
/**
 ...
 * ```
 */
export declare function errorResponse(status: HTTPStatus, error: ErrorTranslationKey | TranslatableMessage, details?: Omit<ErrorResponseBody, 'error'> & Record<string, unknown>): ControllerHandlerReturnType<never>;
