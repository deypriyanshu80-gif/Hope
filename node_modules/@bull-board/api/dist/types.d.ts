...
export type AfterHook = (context: HookContext, result: ControllerHandlerReturnType) => Promisify<ControllerHandlerReturnType>;
...
export type MetricsHistoryGranularity = v.InferOutput<typeof schemas.metricsHistoryGranularitySchema>;
/**
 ...
 */
export type MetricsLatencyGranularity = v.InferOutput<typeof schemas.metricsLatencyGranularitySchema>;
...
export type MetricsHistoryPurgeResult = v.InferOutput<typeof schemas.metricsHistoryPurgeResultSchema>;
/**
...
export interface AppControllerRoute<TResponse extends keyof ResponseSchemas = keyof ResponseSchemas, TQuery = Record<string, any>, TBody = Record<string, any>> {
    method: HTTPMethod | HTTPMethod[];
    route: string | string[];
    spec: RouteSpec<TResponse>;
    handler(request?: BullBoardRequest<TQuery, TBody>): Promisify<ControllerHandlerReturnType<ResponseSchemas[TResponse]>>;
}
